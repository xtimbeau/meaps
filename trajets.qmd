...
gg_carte_km <- ggplot() + 
  ...
  labs(caption= "Source : MOBPRO, EMP 2019, C200, MEAPS")
...
```{r}
#| label: fig-prixkm
#| fig-cap: "revenus, kilomètre, densité et niveau de vie, La Rochelle"
#| fig-asp: 1
...
gg[[3]] <- gg[[3]] +
  ...
  labs(caption = "Note : en gris en haut et à droite sont indiqués la densité de distribution des actifs suivant respectivement les kilomètres parcourus et le revenu par unité de consommation\nSources : MOBPRO, EMP 2019, C200, MEAPS")
