---
title: "La Ville Compacte, solution aux émissions de gaz à effet de serre ?"
...
Bien qu'il soit délicat de tirer une conclusion simple et univoque du large panel d'analyses sur le lien entre densité et émissions, des mesures de la forme urbaine comme la densité d'habitants ou d'emploi, parfois des mesures plus complexes comme la dimension fractale du bâti [@blaudindethé], la diversité locale de l'emploi, des indicateurs de centralité, de connectivité ou de continuité [@ewing2015] sont corrélées négativement avec le nombre de kilomètres-voyageurs (abrégé en ***V**ehicule **K**ilometers **T**raveled* ou ***V**ehicule **M**iles **T**raveled* dans la littérature en langue anglaise).

Cette corrélation est en partie causale bien qu'un effet de sélection des ménages – ceux dont de moindres revenus obligent vers des déplacements plus courts et non motorisés habitent des zones plus denses et généralement des logements plus petits, plus proches du centre-ville, du moins du *downtown* des villes américaines – pollue le lien de causalité et réduit l'élasticité entre densité et VKT. En augmentant la densité des ménages équipés en voiture, aux revenus plus élevés, on ne réduirait pas pour autant les déplacements qu'ils souhaitent et peuvent faire quelqu'en soient les motifs.

[@duranton2018] concluent pour les Etats-Unis à une élasticité de l'ordre de -0.1 entre densité et kilomètres parcourus. [@holian2020] dans la suite de [@grazi2008] utilise une variable instrumentale astucieuse (le fait d'avoir des enfants de même sexe permet de les loger dans une même chambre et offre à ces ménages plus de choix résidentiel sans lien avec leurs préférences de déplacement) et concluent à une élasticité proche – mais ils mesurent un effet local moyen sans pouvoir séparer des contextes urbains très différents – de celles rapportées dans la littérature ; par ailleurs, le biais d'endogénéité qu'ils identifient reste assez faible.

Le tableau suivant (@tbl-stevens2017) est extrait de la méta-analyse de [@stevens2017] qui synthétise la littérature en essayant de prendre en compte la diversité des mesures possibles pour calculer des élasticités comparables. L'auto-sélection des individus, c'est-à-dire le fait que les ménages sont triés spatialement en fonction de leurs préférences et de leurs revenus se traduit par une élasticité des kilomètres-voyageurs à la distance au centre-ville ou à la densité plutôt supérieure lorsqu'elle est prise en compte. L'élasticité à la densité de population est plutôt faible bien que supérieure à celle de @duranton2018.
...
La troisième conclusion que l'on peut tirer des ces analyses est que la quantification de l'étalement urbain ou de son opposé, la compacité urbaine, est un exercice difficile et qui n'a pas été conduit à son terme. Il s'agit de relier d'une part la distribution spatiale des habitants, de l'autre celle des emplois et des différents services comme les écoles ou les commerces de proximité, de prendre en compte les possibilités de transport offertes en chaque point du territoire tout en intégrant d'autres contraintes comme la congestion des transports, les conséquences pour la santé, les ilots de chaleurs, et ainsi de suite Or cette complexité ne peut pas se résumer à quelques indicateurs agrégés ou strictement localisés. Et, pour les mêmes raisons, les politiques publiques ne peuvent pas se concevoir ou s'évaluer uniquement à travers un prisme qui écraserait toute l'information nécessaire pour retranscrire la réalité d'une géographie urbaine donnée.

Comme le notent de nombreux auteurs [@ewing2010; @ewing2017, @stevens2017], la distance au centre (CBD) joue un rôle plus important que d'autres facteurs[^2]. Toutefois, cette notion est un concept difficile à utiliser. Elle est pertinente pour les formes urbaines monocentriques ou encore lorsque la concentration spatiale de l'emploi est importante, mais elle devient difficile à définir lorsque les formes urbaines sont plus complexes et, plus encore, pour des zones urbaines de grande taille. Prenons le cas de l'agglomération parisienne, où pourtant l'hypercentre joue un rôle éminent. On ne peut pas considérer pour autant que l'emploi est particulièrement concentré sur l'Île de la Cité ou l'Île Saint Louis. L'emploi est diffus sur une large zone, avec des zones plus concentrées comme la rive droite (Opéra, Havre-Caumartin, Champ-Elysées), la Défense ou encore Saint-Denis. Mais, malgré cette concentration, il y a de l'emploi un peu partout, que ce soit des emplois liés à la présence de résidents ou liés à des équipements non centraux (un hôpital, une université, un pôle administratif privé ou public, une zone commerciale, etc...).

[^2]: Il est difficile de comparer les élasticités de variables aussi disparates que la densité et la distance au centre. Dans le cas d'une densité uniforme de population sur une cercle de rayon $r$, la densité ($N/{\pi r^2}$) et la distance moyenne au centre du cercle ($\pi r^2$) sont inversement proportionnels. Dans ce cas, la relation est donc simple et peu justifier la comparaison. Si l'on prend une densité gaussienne, le ratio entre la densité et la distance moyenne pondérée par la population est proportionnel au paramètre de dispersion de la densité ($\sigma$). Il est alors facile de construire, avec des distributions plus ou moins concentrées, pour une même densité, une grande palette de distances moyennes.

D'après FLORES (INSEE), en 2021, les 9 arrondissements à 1 chiffre concentrent un peu plus de 800 000 emplois salariés sur les 4,26 millions que compte la région Ile de France. L'emploi salarié dans les arrondissements centraux est donc de 19% de l'emploi de la région pour moins d'1% de la surface. Il y a indéniablement concentration spatiale. Mais pour autant plus de 80% des emplois salariés sont à l'extérieur de ce petit noyau central. Ce qui est vrai pour Paris l'est pour toute grande agglomération, de Tokyo à Los Angeles, et fait du modèle monocentrique une approximation grossière, qui n'est pertinente que pour quelques agglomérations de petite taille et de structure spécifique.

Ne pas pouvoir prendre en compte la répartition spatiale de l'emploi et des activités dans toutes les dimensions est également un frein à une analyse des politiques publiques dont l'objet est souvent le développement de telle ou telle zone, pour des raisons diverses allant de la stratégie d'aménagement générale de la zone urbaine, de son articulation avec les réseaux de transport, à la réhabilitation de terrains, selon leur disponibilité ou leur prix. La décision publique ne se limite pas à plus de densité en général et il faut que l'analyse se base sur ce qui compte localement.

## Pourquoi et comment projeter ?

### Pourquoi ?

C'est à partir de la troisième conclusion (la difficulté de la quantification) que nous proposons une approche différente du lien entre densité et kilomètres parcourus. Au lieu de partir d'observations individuelles ou agrégées de mobilité, qui associent des déplacements à des informations sur la forme urbaine générale ou locale pour quantifier avec plus ou moins de bonheur un lien causal, nous proposons d'expliciter par une modélisation l'articulation entre les distributions spatiales des habitants, des emplois et des liens que la géographie et les infrastructures permettent.
...
Cette démarche est celle des sciences du climat et @masson2014 en discutent la validité pour l'analyse des villes et du changement climatique. Plus généralement, dès que l'on a affaire à des systèmes complexes [@thurner2018], on est confronté à une double difficulté : d'un côté, les causalités s'imbriquent et toute analyse empirique devient difficile voire impossible à moins que l'on dispose de sources de variations aléatoires qui ramènent à un cas quasi-expérimental. Lorsque c'est le cas, les expériences quasi naturelles observables doivent être suffisamment nombreuses pour produire des conclusions généralisables. De l'autre côté, il n'est pas assuré qu'un système complexe puisse être décrit par des relations simples entre quantités macroscopiques. Il existe quelques exemples de telles propriétés émergentes, comme la loi de Boyle-Mariotte et qui ont des domaines de validité bien définie. Mais, dans le cas général, un système complexe est toujours plus riche que la description macroscopique. Ces deux arguments se recoupent partiellement, l'approche par quasi expérience étant d'autant plus généralisable que des lois macroscopiques valides et pleine de signification émergent du système complexe.

L'approche par modélisation, validation des briques par des (quasi-) expériences naturelles, simulation numérique ou analyse des propriétés est alors une méthode pertinente poursuivie, entre autres, par [@batty2013; @bettencourt2021] ou encore dans les modèles LUTI. Le recours à une formulation du problème plus micro fondée, décrivant plus en détail la complexité du système n'est pas pour autant la garantie d'une meilleure compréhension ni d'une représentation exempt de biais. La modélisation doit restée parcimonieuse et ne pas introduire de complexité que l'on ne comprend plus. La simulation numérique rend difficile la compréhension de la modélisation surtout lorsque celle-ci se déploie dans des espaces de grande dimension (formés les variables observées, les paramètres du modèle). De plus, la profondeur du modèle doit être fonction de la nature des données que l'on a à sa disposition. Un modèle qui repose sur une paramétrisation qui dépasse de loin la dimension des observations ne pourra qu'être sur ajusté, parce qu'il existe plus de paramètres à calibrer que de configuration d'observations possibles. Le sur ajustement peut donner le sentiment que l'on explique bien les observations, mais c'est au prix d'une impossibilité de généralisation, ce qui est précisemment ce que l'on cherche à faire par la modélisation.

Les briques de la modélisation structurelle que nous allons mettre en place sont multiples et s'inspirent de la construction du modèle à 4 étapes [@handbook2007; @patrickbonnel2001]. Les quatre étapes sont : la génération du nombre de trajets en partance de chaque origine (les résidences), et des trajets qui arrivent à chaque destination (les emplois, les aménités). La deuxième étape distribue ces trajets sur l'ensemble des paires origine-destination. La troisième étape est celle du choix modal de chacun des trajets et la quatrième vise à déterminer le tracé du trajet, compte tenu de l'origine, de la destination et du mode de transport.
...
+--------------+-----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| facteur      | description                                                                                                                             | modélisation                                                                                                                                                                                                                          | source de données                                                                                                                                                     |
+:=============+:========================================================================================================================================+:======================================================================================================================================================================================================================================+:======================================================================================================================================================================+
...
### De l'auto-sélection et du biais d'endogénéité

La construction de ce modèle, sous ces hypothèses, apporte une réponse au moins partielle au problème d'auto-sélection ou de tri spatial identifié dans la littérature et évoqué plus haut.

En effet, la stratégie retenue dans la littérature revue à la @sec-densemis consiste à estimer pour chaque individu observé le lien entre les kilomètres parcourus et les caractéristiques $X_k$ de l'individu, les caractéristiques $H_i$ de l'endroit $i(k)$ où cet individu $k$ vit et les caractéristiques $E_j$ de l'endroit $j(k)$ où il travaille (voir [@blaudindethé2021] pour une formulation récente) :

$$ km_k = \alpha X_k + \beta H_{i(k)} + \gamma E_{j(k)} + \varepsilon_k $$ {#eq-estime}

Le problème d'endogénéité découle de ce que la densité qui est dans le vecteur $E_{j(k)}$ est corrélée négativement avec les caractéristiques individuelles du vecteur $H_{i(k)}$. Des ménages à revenu élevés, qui possèdent plusieurs voitures, préfèrent habiter loin parce qu'ils ont des temps de transport faibles grâce à leurs voitures. Ils peuvent bénéficier de surfaces plus grandes et d'un agrément extérieur plus important et ne craignent pas les kilomètres induits.

Notre approche est différente puisque nous estimons chaque composante de l'@eq-kmmod séparément, pour chaque catégorie $k$ d'individu ou de ménage. La distance peut intervenir comme variable explicative, mais la variable expliquée n'est pas le nombre de kilomètres parcourus, immédiatement reliés à la distance à l'emploi, mais la fréquence des trajets ou la complexités des boucles. Ces grandeurs peuvent théoriquement être liées aux individus plus d'aux distances qu'ils parcourent, mais le biais qui subsiste sera plus faible que dans le cas où on explique les kilomètres.

Dans notre approche, les distances sont évaluées en tenant compte du lieu de résidence du ménage ou de l'individu et de celui de son emploi. La densité n'intervient donc pas et l'observation (ou l'imputation) de la localisation des individus de la catégorie $k$ affronchi de la question de l'autosélection. Le tri spatial des individus ou des emplois ne biaise donc pas l'estimation du nombre agrégé des kilomètres parcourus, tout au moins bien moins que dans la méthode où on observe densité et distance simultanément pour un individu sans pouvoir séparer l'un de l'autre.

Le lien entre la variable estimée par l'@eq-estime et l'expression de l'@eq-kmmod illustre cette nuance. Les kilomètres moyens parcourus par un individu moyen de la catégorie $k$ dépend de l'échantillon géographique $\mathcal{S}$ :

$$ km^m_k = \frac{1}{n_{k}(ij \in \mathcal{S})} \sum_{ij \in \mathcal{S}}km^m_{ijk} $$

Théoriquement, l'auto-sélection pourrait biaiser les estimations réalisées pour la fréquence des boucles, leur complexité ou la probabilité modale. Le lien entre le tri spatial et les distances $d_{ij}$, et donc la localisation, est immédiat ; il est beaucoup moins clair pour les comportements de mobilité, conditionnellement à la localisation. La méthode employée contourne ainsi un des points soulevé dans la littérature quant à l'auto-sélection des individus.

Nous retrouverons la question de l'autosélection ou du tri spatila non pas pour estimer le nombre de kilomètres parcourus mais lorsque nous voudrons évaluer la variation de kilomètres que l'on peut attendre d'une modification de la localisation d'un ménage. En effet, l'expérience de pensée qui consiste à changer la localisation d'un ménage ou d'un individu ne peut omettre la question de la vraisemblance de ce scénario : est ce que l'individu ou le ménage acceptent cette localisation ? Ainsi posée la question est cependant bine plus claire. La question de l’acceptation du scénario peut être explicitement débattue, elle peut être "forcée" que ce soit pas une forme de contrôle social, surtout si le débat est une délibération collective, ou par une réglementation comme le zonage ou l'ouverture de droits à construire limités et localisés. Enfin, les préférences individuelles des ménages qui s'installent n'ont aucune raison d'être celles des ménages moyens que l'on a observé dans une enquête réalisée à une autre époque, dans un autre contexte ou dans un autre endroit et qui consiste à céder au syndrôme de l'anecdote dénoncé par Heckman ou Deaton à propos des estimateurs locaux, même sans biais. Ainsi, à défaut de le résoudre complètement, nous pensons largement clarifier la question liée au biais d'endogénéité.
...
On peut voir dans le @tbl-rum-tc les estimations du modèle dans le cas où il y a des transports en commun. Le modèle à un $R^2$ de McFadden de `r mfr2`. Le modèle sans la possibilité de transports en commun n'est pas très différent.
...
fdc <- qs::qread("output/decor_carte.sqs")
gg_carte_km <- ggplot() + fdc + 
    geom_sf(data = carte_kmnav, aes(fill = kmpa), linewidth = 0.01, col = "white")+
    scale_fill_distiller("Motif professionel\nKilomètres par actif par an", palette="Spectral")
...
Km parcourus en voiture par un navetteur pour ses déplacements professionels
:::
...
Il est intéressant de relier cette simple analyse aux variations de l'élasticité de la densité ressentie[^7]. On observe tout d'abord que l'élasticité de la densité peut être négative. En effet, lorsque l'on augmente le nombre d'individu dans une zone peu dense, deux effets contradictoires se superposent : d'un côté, on augmente la densité de cette zone, mais d'un autre côté, on augmente la probabilité qu'un individu pris au hasard soit un individu de cette zone peu dense, ce qui a pour effet de diminuer l'espérance de densité. Quand ce deuxième effet domine, la densité ressentie diminue. C'est ce qui se produit pour une partie des IRIS situés en haut du graphique : le choc démographique augmente de fait le nombre de ruraux et diminue donc la densité ressentie. Il apparaît donc plus clairement un lien entre densification ressentie et amélioration du bilan kilométrique par actif.
