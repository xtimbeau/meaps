...
Nous utilisons de nombreux packages et logiciels libres dont `tidyverse`, `data.table`, `matrixStats`, `R5`, `r5r`, `Rcpp`, `OpenMP, quarto, shiny, shinyWidgets, shinydashboard, future, progressr.`
:::
