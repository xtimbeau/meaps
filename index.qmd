...
La comparaison systématique avec le modèle gravitaire montre que MEAPS est plus à même de décrire les flux de déplacements.
La modélisation et son calibration sur des données permet d'analyser des scénarios variantiels pour la Rochelle.
