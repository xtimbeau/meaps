...
If we take the example of the geographical matching of jobs and residents, proximity to the job is an inescapable factor, even if other factors come into play in the choice of a job: salary, skills, etc. The role of distance in job choice is generally assessed using a gravity model. Few alternatives have been studied in the literature, and the gravity model has become a standard, a tool that can be forgotten in favour of taking other factors into account.
