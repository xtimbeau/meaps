...
There are relatively few publications that systematically compare the gravity model with other formulations that respect Tobler's first law. @heanue1966 is one of the first attempts of this kind. Recent work by [@lenormand2016; @commenges2016; @jean-michelfloch2019] confirm what @masucci2013 concluded after the initial publication of the radiative model: that the extended gravity model would have better explanatory power with regard to inter-communal mobility flows, this constant holding for many zones considered in several countries. The usual extension of the gravity model is to write, where $c$, $\alpha$, $\beta$ and $\delta$ are positive parameters:
