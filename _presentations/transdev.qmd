...
Notons également que par cette approche on peut "calibrer" les modélisations pour reproduire fidèlement des données issues d'enquêtes. C'est le cas dans @meaps2024b où

Cette méthode peut être employée pour "ajuster" le modèle à des sources de données différentes, aux résolutions différentes. La fonction de perte (cas d'un petit nombre de paramètres)
