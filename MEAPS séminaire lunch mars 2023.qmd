...
2.  On impose une structure paramétrique de faible dimension (1 ou 2 dasn nos exemples) et on peut faire une optimisation numérique. La structure peut relier les $\omicron_{ij}$ à la distance, au voisinage, etc...
...
MEAPS dispose de microfondements et d'une agrégation explicite et flexible qui peut s'appliquer à plusieurs situations :
...
On peut interpréter le biais intra-communal, le comparer entre territoires
...
-   un chiffre agrégé plus fiable que les estimations habituellement produite. L'évaluation sur MOBPRO a une résolution spatiale trop faible, on peut gagner en précision gràce à l'interpolation et l'utilisation d'une information sur la géographie

-   une intrapolation (avec fiabilité) en se calant sur les données à la maille commune et en utilisant l'information géographique (carte de CO~2~ , ville du 1/4 d'heure par exemple)
