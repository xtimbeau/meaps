...
Si on dispose d'une information sur la probabilité de fuite par indidividu ou par groupe d'individus, le nombre de degré de liberté peut être accru par une probabilité de fuite différenciée selon ces groupes.
