...
Notons que l'échantillon des mobilités donné par @MOBPRO pour l'agglomération de la Rochelle est trsè particulier. Une commune (la Rochelle, dont le code géographique est 17300) représente presque 29% des flux de mobilité (de la Rochelle lieu de résidence vers la Rochelle lieu d'emploi). C'est donc un schéma monocentrique, où à la fois les résidents et les emplois sont concentrés sur un territoire réduit. La résolution spatiale de @MOBPRO ne nous permet pas d'en détailler la structure plus fine.
